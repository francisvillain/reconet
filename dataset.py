        ...
        for dirpath, dirnames, filenames in os.walk(os.path.join(root_dir, "frames_finalpass")):
            ...
            for i in range(1, len(filenames)):
                yield SceneFlowEntry(
                    ...
                    self.forward_optical_flow_path("D:/TrainData/monkaa", scene, side, self.frame_number(filenames[i - 1])),
                    self.reverse_optical_flow_path("D:/TrainData/monkaa", scene, side, self.frame_number(filenames[i])),
